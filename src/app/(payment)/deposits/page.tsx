...
import { ExtenedDeposit, DepositStatus } from "@/type/payment";
      ...
      <>
        <div className="overflow-x-auto border rounded-md">
          <Table className="  ">
            ...
            <TableBody>
              {deposits?.map((deposit: ExtenedDeposit) => (
                ...
                {selectedDeposit?.status === "PENDING" ? (
                  <>
                    <Button
                      ...
                      variant="destructive"
                      onClick={() =>
                        handleApproval(selectedDeposit.id, "reject")
                      }
                      className="!rounded-button whitespace-nowrap cursor-pointer"
                    >
                    ...
                    <Button
                      disabled={approvalActionLoading}
                      onClick={() =>
                        handleApproval(selectedDeposit.id, "approve")
                      }
